...
$EndSheet
$Sheet
S 3320 2785 2090 1190
U 59D58014
F0 "INPUT_AMP" 60
F1 "input.sch" 60
F2 "RF_IN" I L 3320 3385 60 
F3 "RF_OUT" I R 5410 3305 60 
F4 "EN1" I L 3320 3665 60 
F5 "EN2" I L 3320 3765 60 
$EndSheet
$Sheet
...
F4 "OUT" I R 10210 2925 60 
$EndSheet
Text Notes 7915 3805 0    60   ~ 0
+0 dB, 5V 60mA
Text Notes 3710 4155 0    60   ~ 0
+0-30 dB, 3.3V 30mA
...
Wire Wire Line
	2915 1650 3955 1650
$Sheet
S 1450 3325 1380 690 
U 5A51736E
F0 "LEVELSHIFTER" 60
F1 "levelshifter.sch" 60
F2 "OUT1" I R 2830 3665 60 
F3 "OUT2" I R 2830 3765 60 
F4 "IN1" I L 1450 3665 60 
F5 "IN2" I L 1450 3765 60 
$EndSheet
Wire Wire Line
	3040 2755 3040 3385
Wire Wire Line
...
U 1 1 5A51B599
P 1040 3665
F 0 "J106" H 1040 3765 50  0000 C CNN
F 1 "Conn_01x02" H 1040 3465 50  0000 C CNN
F 2 "Socket_Strips:Socket_Strip_Straight_1x02_Pitch2.54mm" H 1040 3665 50  0001 C CNN
F 3 "" H 1040 3665 50  0001 C CNN
	1    1040 3665
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5A511684
P 3525 1840
F 0 "J103" H 3525 1940 50  0000 C CNN
F 1 "Conn_01x01" H 3525 1740 50  0000 C CNN
F 2 "Connectors:1pin" H 3525 1840 50  0001 C CNN
...
U 1 1 5A5123F2
P 4955 2190
F 0 "J102" H 4955 2290 50  0000 C CNN
F 1 "Conn_01x01" H 4955 2090 50  0000 C CNN
F 2 "Connectors:1pin" H 4955 2190 50  0001 C CNN
...
U 1 1 5A512B21
P 10540 2925
F 0 "J105" H 10540 3025 50  0000 C CNN
F 1 "Conn_01x01" H 10540 2825 50  0000 C CNN
F 2 "Connectors:1pin" H 10540 2925 50  0001 C CNN
F 3 "" H 10540 2925 50  0001 C CNN
	1    10540 2925
	1    0    0    -1  
$EndComp
Wire Wire Line
	10340 2925 10210 2925
$Comp
L Conn_Coaxial J109
U 1 1 5A5A7286
P 1620 2755
F 0 "J109" H 1630 2875 50  0000 C CNN
F 1 "Conn_Coaxial" V 1735 2755 50  0000 C CNN
F 2 "rajsradar:132322" H 1620 2755 50  0001 C CNN
F 3 "" H 1620 2755 50  0001 C CNN
	1    1620 2755
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5A5A73C3
P 7055 1580
F 0 "J108" H 7065 1700 50  0000 C CNN
...
U 1 1 5A5A8BA4
P 1620 3045
F 0 "#PWR025" H 1620 2795 50  0001 C CNN
F 1 "GND" H 1620 2895 50  0000 C CNN
...
U 1 1 5A81DCC1
P 7055 1870
F 0 "#PWR?" H 7055 1620 50  0001 C CNN
...
U 1 1 5AB9E28B
P 5695 2095
F 0 "R?" H 5725 2115 50  0000 L CNN
F 1 "50" H 5725 2055 50  0000 L CNN
F 2 "" H 5695 2095 50  0001 C CNN
...
U 1 1 5AB9E91D
P 5695 2265
F 0 "#PWR?" H 5695 2015 50  0001 C CNN
...
U 1 1 5ABA127F
P 7070 2455
F 0 "R?" H 7100 2475 50  0000 L CNN
F 1 "18" H 7100 2415 50  0000 L CNN
F 2 "" H 7070 2455 50  0001 C CNN
...
U 1 1 5ABA1386
P 7270 2610
F 0 "R?" H 7300 2630 50  0000 L CNN
F 1 "56" H 7300 2570 50  0000 L CNN
F 2 "" H 7270 2610 50  0001 C CNN
...
U 1 1 5ABA147B
P 7270 2805
F 0 "#PWR?" H 7270 2555 50  0001 C CNN
...
U 1 1 5ABA17C3
P 7455 2455
F 0 "R?" H 7485 2475 50  0000 L CNN
F 1 "18" H 7485 2415 50  0000 L CNN
F 2 "" H 7455 2455 50  0001 C CNN
...
U 1 1 5AB92165
P 6155 1680
F 0 "U?" H 6155 1830 60  0000 C CNN
F 1 "CP0402Q5425ENTR" H 6155 1430 60  0000 C CNN
F 2 "" H 6155 1730 60  0001 C CNN
...
F 1 "Conn_01x03" H 1300 1550 50  0000 C CNN
